# -*- coding: utf-8 -*-
"""Aula 04 - Pratica - BERT.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1X0E9Euo-fZFioJWcW6lVH7KY3t2Szyy7
...
Realizando o fine-tuning do BERT para a tarefa de classificação de sentimento.

Faremos o fine-tuning do BERT na base do IMDB (https://www.tensorflow.org/datasets/catalog/imdb_reviews) e faremos uma classificação de sentimentos binária.

## Dica para carregar e explorar o dataset do IMDB
...
#### Intuições para a codificação de sentenças
...
for key, val in imdb_train.items():
  print(key, val)
  break

imdb_batch = {key: val[:2,:max_sent_length] for key, val in imdb_train_enc.items()}

imdb_batch

bert_classifier(
    imdb_batch, training=True
).numpy()
