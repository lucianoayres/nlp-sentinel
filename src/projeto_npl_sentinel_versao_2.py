# -*- coding: utf-8 -*-
"""Projeto_npl-sentinel-versao-2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1TpvhAvSCIUNvpEGziY5FV3MKKqE0u_5T
...
### 🔍 Visão Geral  
O **NPL-Sentinel** é um projeto que explora **Processamento de Linguagem Natural (PLN)** para analisar sentimentos expressos em avaliações de consumidores sobre um produto fictício: um **smartphone**. 📱✨
...
- **💬 review:** Comentário livre do consumidor sobre o produto.  
...
# Pré-processa o texto das avaliações
